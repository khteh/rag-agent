...
async def test_email_escalate_safety_protocol(EmailRAGFixture):
    ...
    config = RunnableConfig(run_name=test_email_escalate_safety_protocol.__name__, configurable={"thread_id": uuid7str()})
    """
    ...
    ai_message: type='ai' 
                content='The email from OSHA to Blue Ridge Construction indicates that there are several safety violations at the construction site in Dallas, TX. 
                        ...
                        Ensure all workers on-site are provided with necessary PPE and conduct safety training on proper usage.\n\nThe deadline for compliance is November 10, 2026. Failure to comply may result in fines of up to $25,000 per violation. \n\n
                ...
                original={'type': 'ai', 'data': {'content': 'The email from OSHA to Blue Ridge Construction indicates that there are several safety violations at the construction site in Dallas, TX. The violations include:\n\n1. Lack of fall protection: 
                        ...
                        This situation meets the escalation criteria because workers are explicitly violating safety protocols by not using required harnesses or other fall protection equipment, and not wearing proper PPE.', 
                	'additional_kwargs': {}, 
                	'response_metadata': {'model': 'llama3.3', 'created_at': '2026-04-05T07:27:29.787284732Z', 'done': True, 'done_reason': 'stop', 'total_duration': 368677640273, 'load_duration': 23849621, 'prompt_eval_count': 1229, 'prompt_eval_duration': 31958590162, 'eval_count': 242, 'eval_duration': 336691893036, 
...
async def test_email_escalate_fire_safety_violation(EmailRAGFixture):
    ...
    config = RunnableConfig(run_name=test_email_escalate_fire_safety_violation.__name__, configurable={"thread_id": uuid7str()})
    """
    Should escalate because the workers are violating safety protocols by not wearing PPE.
    ai_message: type='ai' 
                content='The email from the City of Los Angeles Building and Safety Department indicates that there are building code violations at the Sunset Luxury Condominiums project site. The violations include exposed electrical wiring, insufficient fire extinguishers, and temporary support beams that do not meet load-bearing standards.\n\n
                        ...
                        The required changes include replacing or properly securing exposed wiring, installing additional fire extinguishers, and reinforcing or replacing temporary support beams. The deadline for compliance is October 31, 2026, and failure to comply may result in a stop-work order and additional fines.\n\n
                ...
                original={'type': 'ai', 'data': {'content': 'The email from the City of Los Angeles Building and Safety Department indicates that there are building code violations at the Sunset Luxury Condominiums project site. The violations include exposed electrical wiring, insufficient fire extinguishers, and temporary support beams that do not meet load-bearing standards.\n\n
                        ...
                        It is recommended that the project team contact the Building and Safety Department at (555) 456-7890 or email inspections@lacity.gov to schedule a re-inspection and ensure that all necessary corrections are made.', 
                    'additional_kwargs': {}, 
                    'response_metadata': {'model': 'llama3.3', 'created_at': '2026-04-06T07:57:05.968443296Z', 'done': True, 'done_reason': 'stop', 'total_duration': 318870900880, 'load_duration': 22874763, 'prompt_eval_count': 1135, 'prompt_eval_duration': 29028968866, 'eval_count': 207, 'eval_duration': 289815684097, 
    ...
    ---
    The email from the City of Los Angeles Building and Safety Department indicates that there are building code violations at the Sunset Luxury Condominiums project site. The violations include exposed electrical wiring, insufficient fire extinguishers, and temporary support beams that do not meet load-bearing standards.
    ...
    The deadline for compliance is October 31, 2026. It is essential to contact the Building and Safety Department at (555) 456-7890 or email inspections@lacity.gov to schedule a re-inspection and confirm that the necessary changes have been made.
    """
    ...
    assert "installing additional fire extinguishers" in ai_message.content.lower()
    assert "reinforcing or replacing temporary support beams" in ai_message.content.lower()
...
async def test_email_should_NOT_escalate(EmailRAGFixture):
    ...
    config = RunnableConfig(run_name=test_email_should_NOT_escalate.__name__, configurable={"thread_id": uuid7str()})
    """
    ...
    ai_message: type='ai' 
                content='The email from OSHA does not mention a risk of fire or water damage at the site. The identified safety violations are related to lack of fall protection, unsafe scaffolding setup, and inadequate personal protective equipment (PPE). 
                            Therefore, based on the provided escalation criteria, this issue does not require immediate escalation. However, it is crucial for Blue Ridge Construction to address these violations by the deadline of November 10, 2026, to avoid potential fines of up to $25,000 per violation.' 
                tool_calls=[] tool_call_id=None
                original={'type': 'ai', 'data': {'content': 'The email from OSHA does not mention a risk of fire or water damage at the site. The identified safety violations are related to lack of fall protection, unsafe scaffolding setup, and inadequate personal protective equipment (PPE). 
                            Therefore, based on the provided escalation criteria, this issue does not require immediate escalation. However, it is crucial for Blue Ridge Construction to address these violations by the deadline of November 10, 2026, to avoid potential fines of up to $25,000 per violation.', 
                        'additional_kwargs': {}, 
                        'response_metadata': {'model': 'llama3.3', 'created_at': '2026-04-05T07:46:47.7670311Z', 'done': True, 'done_reason': 'stop', 'total_duration': 169713928875, 'load_duration': 34967544, 'prompt_eval_count': 1244, 'prompt_eval_duration': 32563016753, 'eval_count': 102, 'eval_duration': 137111384910, 
                            'message': {'role': 'assistant', 'content': 'The email from OSHA does not mention a risk of fire or water damage at the site. The identified safety violations are related to lack of fall protection, unsafe scaffolding setup, and inadequate personal protective equipment (PPE). 
                                        Therefore, based on the provided escalation criteria, this issue does not require immediate escalation. However, it is crucial for Blue Ridge Construction to address these violations by the deadline of November 10, 2026, to avoid potential fines of up to $25,000 per violation.', 'images': None, 'tool_calls': None}}, 
    ...
    assert "November 10, 2026" in ai_message.content
