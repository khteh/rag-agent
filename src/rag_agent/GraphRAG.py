...
class GraphRAG():
    ...
    def __init__(self, config: RunnableConfig={}):
        ...
        self._llm = init_chat_model(appconfig.LLM_RAG_MODEL, model_provider="ollama", base_url=appconfig.OLLAMA_CLOUD_URI, api_key=appconfig.OLLAMA_API_KEY, streaming=True, temperature=0).bind_tools([self._vectorStore.retriever_tool])
