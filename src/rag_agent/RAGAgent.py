    ...
    async def ChatAgent(self, config: RunnableConfig, message: str, modes: List[str] = ["values"], subgraphs: bool = False, output_queue: Queue = None) -> str:
        ...
        for attempt in range(3):
            try:
                ...
                #additional_kwargs={}
                #response_metadata={'model': 'llama3.3', 'created_at': '2026-04-12T12:23:19.47198126Z', 'done': True, 'done_reason': 'stop', 'total_duration': 428800185880, 'load_duration': 23447133, 'prompt_eval_count': 674, 'prompt_eval_duration': 19170396674, 'eval_count': 265, 'eval_duration': 409602973053, 'message': 
