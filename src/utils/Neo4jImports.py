...
HOSPITALS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/hospitals.csv"
PAYERS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/payers.csv"
PHYSICIANS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/physicians.csv"
PATIENTS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/patients.csv"
VISITS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/visits.csv"
REVIEWS_CSV_PATH = "/usr/src/Python/rag-agent/data/Healthcare/reviews.csv"
